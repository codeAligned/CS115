...
test1 = TestCase $
  assertEqual "matrix addition 1"
    (addSM sm_sample1 sm_sample2) sm_sample1plus2

test2 :: Test
test2 = TestCase $
  assertEqual "matrix addition 2"
    (addSM sm_sample1 sm_sample3) sm_sample1plus3

test3 :: Test
test3 = TestCase $
  assertEqual "matrix addition 3"
    (sm_sample1 <+> sm_sample2) sm_sample1plus2

test4 :: Test
test4 = TestCase $
  assertEqual "matrix addition 4"
    (sm_sample1 <+> sm_sample3) sm_sample1plus3

test5 :: Test
test5 = TestCase $
  assertEqual "matrix multiplication 1"
    (mulSM sm_sample1 sm_sample2) sm_sample1times2

test6 :: Test
test6 = TestCase $
  assertEqual "matrix multiplication 2"
    (mulSM sm_sample1 sm_sample3) sm_sample1times3

test7 :: Test
test7 = TestCase $
  assertEqual "matrix multiplication 3"
    (sm_sample1 <*> sm_sample2) sm_sample1times2

test8 :: Test
test8 = TestCase $
  assertEqual "matrix multiplication 4"
    (sm_sample1 <*> sm_sample3) sm_sample1times3
